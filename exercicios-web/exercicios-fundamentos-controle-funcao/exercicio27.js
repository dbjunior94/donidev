...
console.log(calcularCrescimento(180,5,125,4))
console.log(calcularCrescimento(125,4,180,5))
console.log(calcularCrescimento(125,5, 180,4))
console.log(calcularCrescimento(125,5, 125,5))